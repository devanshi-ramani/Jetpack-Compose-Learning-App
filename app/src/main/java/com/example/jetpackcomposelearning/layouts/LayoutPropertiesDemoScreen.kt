...
fun LayoutPropertiesDemoScreen(onBackClick: () -> Unit) {
    ...
    DemoScreen(
        ...
        Column(
            ...
            Text("The second box takes more space because its weight is 2f.", fontSize = 16.sp)
            Spacer(modifier = Modifier.height(24.dp))

            Text(".height Property Example ", fontSize = 18.sp, textAlign = TextAlign.Center ,modifier = Modifier.fillMaxWidth())
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(80.dp)
